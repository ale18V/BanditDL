...
def _validate_config(c: BanditDLConfig) -> None:
    ...
    if c.heterogeneity.method == "dirichlet":
    ...
    elif c.heterogeneity.method == "pathological":
        ...
        raise ValueError(f"unsupported heterogeneity.method: {c.heterogeneity.method!r}")
...
def _run_name(c: BanditDLConfig, byz_budget: int) -> str:
    return (
        ...
        f"-sampler_{c.resolved_sampler_name}"
