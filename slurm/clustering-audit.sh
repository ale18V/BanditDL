#!/bin/bash
# Cheap CSCS smoke sweep to verify pathological cluster partitioning.
# Inspect each trial's results/audit.json after the job finishes.

#SBATCH --job-name=bdl_cluster_audit
